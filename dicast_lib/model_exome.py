...
class DicastExome:
    ...
    def __init__(self, sv_type: str):
        ...
        self.features_aln_bp = {'DEL': ['ill_isize_mean', 'ill_isize_std', 'ill_mapq_mean', 'ill_mapq_std',
                                        'ill_clipreads', 'ill_splitreads', 'ill_disco_ff', 'ill_disco_rr', 'ill_disco_rf'],
                                'INS': ['ill_isize_mean', 'ill_isize_std', 'ill_mapq_mean', 'ill_mapq_std',
                                        'ill_clipreads', 'ill_splitreads', 'ill_disco_ff', 'ill_disco_rr', 'ill_disco_rf'],
                                'INV': ['ill_isize_mean', 'ill_isize_std', 'ill_mapq_mean', 'ill_mapq_std',
                                        'ill_clipreads', 'ill_splitreads', 'ill_disco_ff', 'ill_disco_rr', 'ill_disco_rf'],
                                'DUP': ['ill_isize_mean', 'ill_isize_std', 'ill_mapq_mean', 'ill_mapq_std',
                                        'ill_clipreads', 'ill_splitreads', 'ill_disco_ff', 'ill_disco_rr', 'ill_disco_rf'],
                                'BND': ['ill_isize_mean', 'ill_isize_std', 'ill_mapq_mean', 'ill_mapq_std',
                                        'ill_clipreads', 'ill_splitreads', 'ill_disco_ff', 'ill_disco_rr', 'ill_disco_rf']}
        self.features_aln_body = {'DEL': [],
                                  'INS': [],
                                  'INV': [],
                                  'DUP': [],
                                  'BND': []}
