...
def caller_vcf_to_dataframe(vcf: pysam.VariantFile, cohort: str, sample: str, reference: str, technology: str, caller: str, canonical_chroms: list, check_genotype: bool=False) -> pd.DataFrame:
    ...
    for rec in vcf.fetch():
        ...
        if sv_type == 'DEL':
            ...
            vcf_dict['sv_len'].append(rec.stop - (rec.start + 1))
